...
from mvo        import simulate_mvo, simulate_naive, _performance_metrics
...
def plot_training_history(save_path: str = None):
    ...
    Each individual plot has three panels:
        ...
        Right  : gradient norm per episode  [NEW]
    ...
    for rt, h in histories.items():
        ...
        plt.suptitle(label, fontsize=13, fontweight="bold")
        plt.tight_layout()
...
if __name__ == "__main__":
    ...
    with open(REPORT_PATH, "w") as rf:
        ...
        mvo_res   = simulate_mvo(test_closes, test_pct, report_file=rf)
